...
While there are more sightings during Summer 14/15 compared to Spring or Autumn, there are less sightings in Summer 13/14 than any other season. This may indicate an annual difference between the two summers, or it may be an artifact of the survey schedule. As Summer 13/14 was the first season of flights for the primary observer, it is possible that there were a lower number of sightings during this season due to observer inexperience. This is very difficult to discern as there is no measure of the learning curve of the observer.
...
There is no apparent relationship between tide height and number of sightings that day for any species.
...
plot(tide_tab[species[1], ]/date_weight, xlab = "tide height (m)", main = "Baitfish", pch = 19, ylab = "")
plot(tide_tab[species[2], ]/date_weight, xlab = "tide height (m)", main = "Bottlenose Dolphin", pch = 19, ylab = "")
plot(tide_tab[species[3], ]/date_weight, xlab = "tide height (m)", main = "Hammerhead Shark", pch = 19, ylab = "")
plot(tide_tab[species[4], ]/date_weight, xlab = "tide height (m)", main = "White Shark", pch = 19, ylab = "")
dev.off()
@

\begin{figure}
  \centering
  \includegraphics[height = 8cm, trim = .5cm .5cm .5cm .5cm, clip]{tide}\\
...
\begin{figure}
  \centering
  \includegraphics[height = 8cm, trim = .5cm .5cm .5cm .5cm, clip]{minDistToFish}\\
...
\FloatBarrier
\subsection{Mean dolphin group size}
...
\begin{figure}
  \centering
  \includegraphics[height = 7cm, trim = .5cm .5cm .5cm .5cm, clip]{groupSize}\\
...
barplot(percentage_size, legend = T, main = "Proportion of baitfish of each size", ylab = "Proportion of fish schools seen during season", args.legend = list(x = ncol(percentage_size) + 1.4, y=1, bty = "n"))
...
boxplot(bot_size$Number ~ bot_size$Season, ylab = "Pod size", main = "Bottlenose dolphin group size for each sighting")
...
\begin{figure}
\centering
\includegraphics[height = 7cm, trim = .5cm .5cm .5cm .5cm, clip]{botGroupSizeSeason}\\
...
Wind speed is expected to have a negative effect on sighting rates/hour. Wind speed in km/h is plotted against sighting rates/hr.\\

This may be because wind is recorded only once per survey, according to the wind speed measured by BOM. Hence apparent sea state is a better measure of the affect of wind on sighting rates since every change in sea state is recorded.
...
matplot(t(wind_north), type = "l", col = c("black", "red", "blue", "orange"), lty = 1, xlab = "Wind speed (km/h)", ylab = "Sightings/hr")
legend("topright", c("Baitfish", "Bottlenose dolphin", "Hammerhead shark", "White shark"), col = c("black", "red", "blue", "orange"), lwd = 2, bty = "n", main = "Flight direction = North")

matplot(t(wind_south), type = "l", col = c("black", "red", "blue", "orange"), lty = 1, xlab = "Wind speed (km/h)", ylab = "Sightings/hr")
legend("topright", c("Baitfish", "Bottlenose dolphin", "Hammerhead shark", "White shark"), col = c("black", "red", "blue", "orange"), lwd = 2, bty = "n", main = "Flight direction = South")
...
\begin{figure}
  \centering
  \includegraphics[height = 7cm, trim = .5cm .5cm .5cm .5cm, clip]{windSpeed}\\
