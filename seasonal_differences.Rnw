...
The table below gives the total nubmer of sightings of each species. North and southbound flights are pooled and observations by the second observer during inter-observer surveys are not included. These are the raw sighting data and have not been weighted by the number of flights or hours flown during each season.\\*
