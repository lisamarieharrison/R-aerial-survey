...
plot(f.hn.function(1:1000, sigma = 1000), type = "l", main = "Half-normal", lwd = 2, xlab = "", ylab = "", cex.main = 2, bty = "l")
plot(f.haz.function(1:1000, sigma = 500, shape = 5), type = "l", main = "Hazard-rate", lwd = 2, xlab = "", ylab = "", cex.main = 2, bty = "l")
plot(f.gamma.function(1:1000, key.scale = 600, key.shape = 1.2), type = "l", main = "Gamma", lwd = 2, xlab = "", ylab = "", cex.main = 2, bty = "l")
