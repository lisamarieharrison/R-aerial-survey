...
foreach(chain = 1:n_chains, scale0 = c(280, 330), shape0 = c(4, 3), int0 = c(0.1, 0.3), species = rep("BOT", n_chains), nz = c(100, 100), truncate_left = c(0, 0), truncate_right = c(1000, 1000)) %dopar% {
